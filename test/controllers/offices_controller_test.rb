...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { address: @office.address, phone: @office.phone, physician_id: @office.physician_id, zip_code: @office.zip_code } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { address: @office.address, phone: @office.phone, physician_id: @office.physician_id, zip_code: @office.zip_code } }
